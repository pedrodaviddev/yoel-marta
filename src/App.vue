  ...
  <Transition name="fade" mode="out-in">
    ...
    <div class="w-100 h-100" v-else>
      ...
      <main class="d-flex flex-column justify-center align-center mt-10 ga-10 px-0">
        ...
        <div class="d-flex flex-column ga-6  icon-images font-cmu">
